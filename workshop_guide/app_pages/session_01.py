...
1. Show the schemas and tables in the AIRLINE_OPS_LABUSERXX database
...
SHOW SCHEMAS IN DATABASE AIRLINE_OPS_LABUSERXX;
SHOW TABLES IN SCHEMA AIRLINE_OPS_LABUSERXX.RESERVATIONS;
SHOW TABLES IN SCHEMA AIRLINE_OPS_LABUSERXX.FLIGHT_OPS;
...
**What you should see:**
- `AIRLINE_OPS_LABUSERXX` — an empty database with `RESERVATIONS` and `FLIGHT_OPS` schemas. The Openflow connector will create and populate the tables here.
...
render_key_concepts([
    ...
    {"term": "CDC Destination", "definition": "The AIRLINE_OPS_LABUSERXX database with empty RESERVATIONS and FLIGHT_OPS schemas. The Openflow connector creates and continuously populates tables here from the source Postgres."},
...
render_what_you_built([
    "Confirmed AIRLINE_OPS_LABUSERXX destination is empty and ready for CDC",
