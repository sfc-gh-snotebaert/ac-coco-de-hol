...
st.info(":material/terminal: Use the `dbt compile` and `dbt run` commands in the UI (bottom pane). There will be errors during the run — click **Fix with CoCo** to fix them.")
