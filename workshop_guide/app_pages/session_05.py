...
render_session_header(5, "Data Engineer Skill (Stretch)", "{{TIME_SESSION_5}}", "{{DUR_SESSION_5}}", "Reusable Cortex Code skill that packages the code review workflow for any dbt project")
