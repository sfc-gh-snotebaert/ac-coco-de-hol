...
-- ============================================================================
-- OPENFLOW CDC PREREQUISITES
-- Source-side setup so the Openflow PostgreSQL CDC connector can replicate
...
CREATE PUBLICATION openflow_pub
  FOR TABLE flight_ops.airports, flight_ops.flights,
            reservations.passengers, reservations.bookings
